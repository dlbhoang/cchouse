...
function LoginPage() {
  ...
  return (
    <>
      ...
      <main className="flex w-full min-h-screen bg-white overflow-x-hidden">
        <section className="relative hidden min-h-screen flex-1 shrink overflow-hidden bg-[#071945] md:block">
          <img
            src="/assets/figma-visual.png"
            alt="C.C.House quản trị bất động sản"
            className="absolute inset-0 block h-full w-full object-cover object-left-top"
          />
        </section>

        <section className="flex min-h-screen w-full shrink-0 flex-col bg-white px-5 py-6 sm:px-10 md:w-[47%] md:max-w-[676px] md:px-[7.5%] md:py-8">
